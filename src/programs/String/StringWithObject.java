    ...
    public static void main(String[] args) {
      ...
      //  System.out.println(black);
       ...
       /* StringBuffer sb=new StringBuffer(s);
        programs.String x="Neeraj";
        programs.String s1=new programs.String("Prince"); //heap
        programs.String s2=new programs.String("ashis");
        s2=s1;
      ...
      //  System.out.println(s2);
        ...
        programs.String substring = s.substring(s.length() / 2);
