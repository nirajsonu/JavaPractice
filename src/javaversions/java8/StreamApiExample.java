    ...
    public static void main(String a[]){
      ...
      //  Stream<Integer> streamInteger = Stream.iterate(1,i->i<=20,i->i*2);
       ...
       /* stringBuilderMethods();
        ...
        concatTwoStreams();
        //for sort string..
        programs.String[] namess={"Neeraj","Soun","Prince","Amit","Bablue"};
        Stream.of(namess).sorted(programs.String::compareToIgnoreCase).forEach(System.out::println);*/
    }
