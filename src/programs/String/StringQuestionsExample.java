...
public class StringQuestionsExample {
    public static void main(String args[]) {
        ...
        //  System.out.println("Enter the 1st programs.String to reverse");
      /*  programs.String text=scanner.nextLine();
        System.out.println("Enter the 2nd programs.String");*/
        //programs.String text1=scanner.nextLine();
        //  System.out.println("Reverse of the programs.String--->"+reverseEachLetter(text));
     ...
     //   wordCount(word);
      ...
      //  programs.String cookieName="My name is neeraj";
